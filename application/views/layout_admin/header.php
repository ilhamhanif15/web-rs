<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url().'assets/AdminLTE-2.4.5/' ?>bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo base_url().'assets/AdminLTE-2.4.5/' ?>bower_components/bootstrap-daterangepicker/daterangepicker.css">
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo base_url().'assets/AdminLTE-2.4.5/' ?>bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
